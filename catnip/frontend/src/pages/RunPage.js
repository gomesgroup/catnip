    ...
    <div>
      ...
      <Box sx={{backgroundColor: "black", color: "white", paddingTop: "64px"}}>
        <Container maxWidth="xl">
          <Tabs value={state.tabValue} onChange={handleTabChange} aria-label="basic tabs example" sx={{backgroundColor: "white"}}>
              ...
              <Grid item xs={6}>
                ...
                <Box sx={{
                  ...
                  <div style={{position: 'absolute', top: 0, left: 0, right: 0, bottom: 0}}>
                    <ScatterPlot data={data} largeDotCoordinates={state.pca_weights} largeDotLegend={state.smilesData}/>
                  </div>
                </Box>
                <br/>
              </Grid>
